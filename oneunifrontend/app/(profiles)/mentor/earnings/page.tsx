...
export default function MentorEarningsPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 px-6 lg:px-10 py-8">
      {/* Header Section */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" className="border-slate-200 text-slate-600 bg-white gap-2 h-11 px-5 rounded-xl font-semibold text-sm">
            <Download size={18} />
            Export Report
          </Button>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 bg-gradient-to-br from-[#1a1c4b] to-[#2a2f91] rounded-[32px] p-8 text-white shadow-2xl shadow-blue-900/40 relative overflow-hidden group">
            <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                   <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-200/80">Available Balance</span>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-emerald-500/20 text-emerald-400 rounded-full text-[10px] font-bold uppercase tracking-widest border border-emerald-500/30">
                            <TrendingUp size={12} />
                            +12% vs last month
                        </div>
                   </div>
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center gap-4">
                    <Button className="w-full sm:w-auto bg-white text-[#1a1c4b] hover:bg-blue-50 font-bold h-14 px-10 rounded-2xl shadow-lg transition-all active:scale-95 text-lg">
                        Withdraw Funds
                    </Button>
                    <div className="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 flex-1 w-full sm:w-auto">
                        <p className="text-[10px] font-semibold text-blue-200/50 uppercase tracking-widest mb-1 text-center sm:text-left">Payout Destination</p>
                        <div className="flex items-center justify-center sm:justify-start gap-3">
                            ...
                            <span className="text-sm font-semibold truncate">HBL Bank •••• 4242</span>
        ...
        <div className="space-y-6">
            <div className="bg-white rounded-[32px] p-6 border border-slate-200/60 shadow-sm">
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-4">Pending Clearance</p>
                <div className="flex items-center justify-between">
                    <h3 className="text-2xl font-bold text-slate-900">Rs. 4,200</h3>
            ...
            <div className="bg-white rounded-[32px] p-6 border border-slate-200/60 shadow-sm relative overflow-hidden group">
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-4">Earnings Goal</p>
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-2xl font-bold text-slate-900">Rs. 12,500 <span className="text-slate-300 font-semibold">/ 25k</span></h3>
                    <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-100 uppercase tracking-wider">50% REACHED</span>
                </div>
                <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div className="h-full bg-emerald-500 w-1/2 rounded-full transition-all group-hover:w-[55%]" />
                </div>
                <p className="text-[11px] text-slate-400 mt-4 font-semibold uppercase tracking-widest">Next Milestone: Bronze Mentor Rank</p>
            </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <span className="text-[11px] font-semibold text-slate-400 tracking-widest uppercase">Filter:</span>
                    <select className="text-xs font-semibold text-slate-700 bg-slate-100 px-3 py-1.5 rounded-lg border-none focus:ring-0 cursor-pointer">
            ...
            <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-slate-50/50 text-slate-400 text-[11px] font-semibold uppercase tracking-widest border-b border-slate-100">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {MOCK_TRANSACTIONS.map((tx) => (
                                <tr key={tx.id} className="group hover:bg-slate-50/50 transition-colors">
                                    <td className="px-8 py-5">
                                        <div className="flex items-center gap-4">
                                            <div className={cn(
                                                ...
                                                tx.amount > 0 ? "bg-blue-50 text-blue-600 border-blue-100" : "bg-red-50 text-red-600 border-red-100"
                                            )}>
                                    ...
                                    <td className={cn(
                                        "px-6 py-5 text-right font-bold text-sm",
                ...
                <div className="p-6 bg-slate-50/50 border-t border-slate-100 text-center">
                    <button className="text-[11px] font-bold text-slate-400 hover:text-[#2a2f91] uppercase tracking-[0.2em] transition-all">Load More Activity</button>
                </div>
            </div>
        </div>
        ...
        <div className="space-y-8">
            <div className="bg-white rounded-[32px] p-8 border border-slate-200/60 shadow-sm relative overflow-hidden flex flex-col items-center text-center">
                <BarChart3 className="text-blue-50 absolute -top-4 -right-4" size={100} />
                <div className="relative z-10 w-full">
                    ...
                    <div className="mt-8 space-y-4 w-full text-left">
                        {[
                            ...
                            <div key={i} className="flex items-center justify-between p-3.5 bg-slate-50/50 rounded-2xl border border-slate-100">
                                <span className="text-[11px] font-semibold text-slate-400 uppercase tracking-widest">{insight.label}</span>
                                <span className="text-sm font-bold text-slate-900">{insight.value}</span>
                            </div>
                        ))}
                    </div>

                    <Button variant="outline" className="w-full mt-8 border-slate-100 text-[#2a2f91] hover:bg-blue-50 font-bold h-12 rounded-2xl group text-xs uppercase tracking-widest">
            ...
            <div className="bg-white rounded-[32px] p-6 border border-slate-200/60 shadow-sm">
                <div className="flex gap-4">
                    ...
                    <div>
                        ...
                        <button className="text-[11px] font-semibold text-[#2a2f91] mt-3 uppercase tracking-widest hover:underline">Download PDF</button>
                    </div>
                </div>
            </div>
        </div>
