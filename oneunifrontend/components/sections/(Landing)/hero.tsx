      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              The comprehensive platform for your entire university journey.
              Manage your application, financial aid, and student life in one
              unified portal.
            </motion.p>
              ...
              <div className="relative w-full h-full flex flex-col justify-between p-8">
                ...
                <div className="absolute bottom-8 left-8 text-white z-20">
                  ...
                  <p className="text-xs opacity-80">
                    Join 50+ Universities Collection
                  </p>
                </div>
