      ...
      <div className="max-w-7xl mx-auto bg-[#1e2266] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Application for the Fall 2026 semester are closing soon. Secure your
            place today.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/coming-soon">
              <Button
                variant="outline"
                className="border-blue-400/30 text-white hover:bg-white hover:text-yellow-500 rounded-full px-8 py-4 text-lg font-medium backdrop-blur-sm"
              >
                Download Prospectus
              </Button>
            </Link>
