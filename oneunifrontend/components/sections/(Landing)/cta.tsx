...
export default function CTA() {
  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto bg-[#1e2266] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
         ...
         <div className="relative z-10">
           ...
           <div className="flex flex-col sm:flex-row gap-4 justify-center">
             ...
             <Button
               variant="outline"
               className="border-blue-400/30 text-white hover:bg-white/10 rounded-full px-8 py-4 text-lg font-medium backdrop-blur-sm"
             >
               Download Prospectus
             </Button>
           </div>
